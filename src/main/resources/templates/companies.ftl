...
<div class="main">
    <div>
        <form method="post" action="/companiesAdd">
        ...
        <form method="post" action="/companiesUpdates">
            <dialog id="dialogUpdate">
                ...
                <input type="text" name="country" placeholder="country">
                <input type="text" name="numberOfEmployees" placeholder="numberOfEmployees">
                <input type="text" name="address" placeholder="address">
                <input type="text" name="phone" placeholder="phone">
    ...
    <table class="table_dark">
        ...
        <#list companies as company>
            <tr>
                ...
                <td><button  class="openDialogUpdate" data-companyName="${company.companyName}"
